                    ...
                    <section>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Form Edit PIC</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group">
                                        <label>Ref No</label>
                                        <input type="text" class="form-control" value="PIC001">
                                    </div>

                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control" value="Andi Pratama">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="number" class="form-control" value="081234567001">
                                    </div>

                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control" value="andi.pratama@mail.com">
                                    </div>
